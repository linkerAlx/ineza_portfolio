...
export const Socials = [
  ...
  export const skills = [
    ...
    {
      name: "React&Next js",
      description: "Building dynamic and scalable applications with React and Next.js.",
      rating: 4,
    },
    {
      name: "GIT&GITHUB",
  ...
  export const services = [
    ...
    },
    {
      ...
      description: "Analyzing projects for efficient execution and impactful outcomes.",
    },
  ];
  ...
  export const cardData = [
    ...
    { hasContent: false },
    {
      ...
      subtitle: 'Portfolio',
      description: '"Shaping the Future of Digital Interaction with Creativity."',
      liveProject: 'https://www.figma.com/design/CwzQ8IC4uRQwuwGrhwO0jd/linker-portfolio?node-id=6-2&t=4KmYFXQxr38BphuN-1',
      hasContent: true,
    },
    { hasContent: false },
    {
